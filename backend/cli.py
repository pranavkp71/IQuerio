...
def main():
    parser = argparse.ArgumentParser(description="IQuerio CLI: SQL Optimizer & Vector Playground")
    parser.add_argument("command", choices=["optimize", "search", "upload", "nl-query"], help="Command to run")
